...
public class Eesa_update_cs extends AppCompatActivity {
    EditText title, time, room_no, date;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eesa_update_cs);
        title = (EditText)findViewById(R.id.eesa_cs_title);
        room_no = (EditText)findViewById(R.id.eesa_cs_room);
        time = (EditText)findViewById(R.id.eesa_cs_time);
        date = (EditText)findViewById(R.id.eesa_cs_date);
    }
    public void update_eesa(View v){
